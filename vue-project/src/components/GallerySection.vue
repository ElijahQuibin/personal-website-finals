  ...
  data() {
    return {
      images: [
        ...
        "/src/assets/gallery/six.webp",
        "/src/assets/gallery/seven.webp",
        "/src/assets/gallery/eight.webp",
        "/src/assets/gallery/nine.webp",
        "/src/assets/gallery/ten.webp",
        "/src/assets/gallery/eleven.webp",
        "/src/assets/gallery/twelve.webp",
      ],
      lightboxOpen: false,
      lightboxIndex: 0,
    };
